...
<div class="container-fluid">
							...
							@foreach($hasil as $key)
								<tr> 
									...
									<td>
										...
										<button class="btn btn-danger btn-xs deleteShippingAgent" data-toggle="modal" data-target=".alertYesNo">Delete</button>
									</td>
								</tr>
							@endforeach
	...
	<script>
		...
		$('body').on('click','.deleteShippingAgent',function(){
			$id = $('#shipAgtId').val();
			$.ajax({
					type: 'DELETE',
