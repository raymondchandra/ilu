<div class="modal fade pop_up_view_newsletter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<p type="text" class="form-control-static">Sebuah Judul Newsletter</p>			
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<p type="text" class="form-control-static">Sebuah Subject Newsletter</p>			
						</div>
						<div class="col-sm-3">
						</div>
					</div>
